...
class AlarmPopUp():
    ...
    def display(self, ring, tone):
        ...
        self.pop_up.geometry('{}'.format(self.master.winfo_geometry()))

        self.pop_up.title("시험이다 시험이다 시험이다!!!")
        ...
        self.image = "C:\\Users\\pkunw\\OneDrive\\바탕 화면\\Alarm\\icons\\alarm-clock.gif"
